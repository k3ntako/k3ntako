...
const Swift = <>
  ...
  <p>
    After work hours at <strong>Memorial Sloan Kettering Cancer Center</strong>, I worked on an iPad app where the lab technicians could enter the data into.
...
const R = <>
  <h2>R</h2>
  <p>I learned <strong>R</strong> through workshops priors to Vassar College's <a href="http://pages.vassar.edu/datafest/" target="_blank">DataFest</a>, a data analysis and visualization competition.</p>
  <p>
    After Vassar, I created a <a href="https://github.com/k3ntako/HouseSearch" target="_blank">program</a> that would <strong>scrape</strong> Zillow, an online real estate website, and output an HTML file.
  </p>
  <p>
    Outside of work hours at <strong>Memorial Sloan Kettering</strong>, I used R to parsed our lab technicians{"'"} Excel files. Inconsistencies in the spreadsheets made it impractical to implement the program, but it was a vital learninng experience.
  </p>
</>
